...
def load_config2(calling_path: str, default_config_path: Optional[str] = None) -> Dict:
    ...
    parser.add_argument("--configrrr", default=default_config_path)
    args, unknown_args = parser.parse_known_args()"""

    with open(calling_path) as f:
